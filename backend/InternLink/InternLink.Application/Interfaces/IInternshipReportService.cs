...
public interface IInternshipReportService
{
    ...
    /// </summary>
    Task<byte[]> ExportC23ExcelAsync(Guid? semesterId = null, string? department = null);

    /// <summary>
    /// Export "Báo cáo tổng kết công tác thực tập tốt nghiệp" as Excel (fallback).
    /// </summary>
    Task<byte[]> ExportC22ASummaryReportAsync(Guid? semesterId = null, string? department = null);
    ...
    /// </summary>
    Task<byte[]> ExportC22AWordReportAsync(Guid? semesterId = null, string? department = null);
}
