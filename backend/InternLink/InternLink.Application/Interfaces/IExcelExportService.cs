...
public interface IExcelExportService
{
    ...
    /// </summary>
    Task<InternshipExportDataDto> GetExportDataAsync(Guid? semesterId = null, Guid? lecturerId = null, string? department = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<byte[]> GenerateInternshipExportExcelAsync(Guid? semesterId = null, Guid? lecturerId = null, string? department = null, CancellationToken cancellationToken = default);
