        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationMinutes = table.Column<int>(type: "int", nullable: true, defaultValue: 60),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_Internships_InternshipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_InternshipId",
                table: "AttendanceRecords",
                column: "InternshipId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_SemesterId_LecturerId_WeekNumber",
                table: "AttendanceSessions",
