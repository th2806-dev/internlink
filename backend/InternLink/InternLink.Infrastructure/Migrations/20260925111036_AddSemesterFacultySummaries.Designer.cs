...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.AccountRequest", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasColumnName("AccountRequestId");
                    ...
                    b.Property<string>("DepartmentOrClass")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.AttendanceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.AttendanceSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("AttendanceSessionId");
                    ...
                    b.Property<bool>("IsLecturerOnly")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.CompanyPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("CompanyPositionId");
                    ...
                    b.HasIndex("CompanyId", "SemesterId");

                    b.ToTable("CompanyPositions", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Document", b =>
                {
                    ...
                    b.HasIndex("SemesterId", "Department", "IsPublished");

                    b.ToTable("Documents", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.DocumentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Evaluation", b =>
                {
                    ...
                    b.Property<string>("DefenseCouncilName")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<string>("DefenseExaminerName")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<int>("DefenseStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<bool>("HasCreativeProduct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<decimal?>("OralExamScore")
                        .HasPrecision(4, 1)
                        .HasColumnType("decimal(4,1)");

                    b.Property<decimal?>("QualityLevel")
                        .HasPrecision(3, 1)
                    ...
                    b.Property<string>("WeeklyQualityJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.EvaluationRubric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("EvaluationRubricId");
                    ...
                    b.ToTable("EvaluationRubrics", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.EvaluationRubricCriterion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("EvaluationRubricCriterionId");
                    ...
                    b.ToTable("EvaluationRubricCriteria", (string)null);
                });
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Semester", b =>
                {
                    ...
                    b.Property<int>("InternshipStartWeek")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.SemesterCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SemesterCompanyId");
                    ...
                    b.HasIndex("SemesterId", "CompanyId")
                        .IsUnique();

                    b.ToTable("SemesterCompanies", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.SemesterFacultySummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SemesterFacultySummaryId");
                    ...
                    b.ToTable("SemesterFacultySummaries", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.SemesterLecturer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SemesterLecturerId");
                    ...
                    b.ToTable("SemesterLecturers", (string)null);
                });

            modelBuilder.Entity("InternLink.Domain.Entities.SemesterReportSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SemesterReportScheduleId");
                    ...
                    b.ToTable("SemesterReportSchedules", (string)null);
                });
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Student", b =>
                {
                    ...
                    b.Property<string>("AlternativePosition")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.SubmissionAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("SubmissionAssetId");
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.AccountRequest", b =>
                {
                    b.HasOne("InternLink.Domain.Entities.User", "RequesterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.AttendanceRecord", b =>
                {
                    b.HasOne("InternLink.Domain.Entities.AttendanceSession", "AttendanceSession")
                        .WithMany("Records")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.DocumentVersion", b =>
                {
                    b.HasOne("InternLink.Domain.Entities.Document", "Document")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Evaluation", b =>
                {
                    ...
                    b.HasOne("InternLink.Domain.Entities.EvaluationRubric", "Rubric")
                        .WithMany()
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.EvaluationRubric", b =>
                {
                    b.HasOne("InternLink.Domain.Entities.User", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("InternLink.Domain.Entities.Semester", "Semester")
                        .WithOne("EvaluationRubric")
                        .HasForeignKey("InternLink.Domain.Entities.EvaluationRubric", "SemesterId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("InternLink.Domain.Entities.User", "SubmittedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Lecturer", b =>
                {
                    b.HasOne("InternLink.Domain.Entities.Department", "DepartmentRef")
                        .WithMany("Lecturers")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("InternLink.Domain.Entities.Lecturer", b =>
                {
                    ...
                    b.Navigation("SemesterLecturers");
                });
