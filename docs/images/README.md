...
| Tên Sơ Đồ | File Nguồn | Mô Tả Nội Dung |
|:---|:---|:---|
| **Sơ đồ Use Case Toàn hệ thống** | [`usecase-diagram.md`](usecase/usecase-diagram.md) | 38 Use Cases: Admin (16, tách SuperAdmin hệ thống / DepartmentAdmin khoa), Lecturer (12), Student (10). Bao gồm Account Requests, Rubric Management, Student Reply, Bulk Notify, PDF Certificate. |
